...
def testMultipleAlgorithms():
    ...
    print(f"count ", count)    
    row1 = ['Selection Sort', len(array), (esult1//10), (result1/10)]
    row2 = ['Insertion Sort', len(array), (esult2//10), (result2/10)]
    row3 = ['Merge Sort', len(array), (esult3//2), (result3/10)]
    row4 = ['Quick Sort', len(array), (esult4//10), (result4/10)]
    row5 = ['Heap Sort', len(array), (esult5//10), (result5/10)]
    row6 = ['Bubble Sort', len(array), (esult6//10), (result6/10)]
    row7 = ['Obs1-Bubble Sort', len(array), (esult7//10), (result7/10)]
    row8 = ['Obs2-Bubble Sort', len(array), (esult8//10), (result8/10)]
    row9 = ['Obs3-Bubble Sort', len(array), (esult9//10), (result9/10)]
    row10 = ['Sink-Down Sort', len(array), (esult10//10), (result10/10)]
    row11 = ['Bi-Directional Sort', len(array), (esult11//10), (result11/10)]  
...
print("Question 3 Automatic Testing Sorting algorithm\n")
looping = True
while looping == True:
    testMultipleAlgorithms()
